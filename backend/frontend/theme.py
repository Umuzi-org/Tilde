...
styles = {
    ...
    "button_content_small": f"rounded bg-{CONTENT_BTN_COLOUR} px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-{CONTENT_BTN_COLOUR} focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-{CONTENT_BTN_COLOUR}",
