from automarker.automarker_test_runner import JavaScriptTestRunner
from automarker.utils import AdapterCommandOutput


def test_get_error_type_and_message_single_line_message():
...
def test_get_error_type_and_message_multi_line_message():
    runner = JavaScriptTestRunner(test_path="", clone_dir_path="")
    runner.last_command_output = AdapterCommandOutput(
        stdout="",
        stderr="""/home/sheena/workspace/Tilde/automarker_2/gitignore/186-javascript-perfect/src/consume_github_api.js:35
