...
export API_BASE_URL=https://backend.tilde.umuzi.org


docker build \
-t gcr.io/umuzi-prod/tilde-frontend-mini-challenge:$GIT_COMMIT-$DATE_STR \
-t gcr.io/umuzi-prod/tilde-frontend-mini-challenge:latest \
