...
# @pytest.fixture(scope="function")
# def mini_frontend_configuration_values(request):  # noqa: F811
#     """Load all the configuration values for this specific test (or suite).
...
#     # value defined by this conftest, specific to this particular test
#     config.update_single_key("host", HOST_FRONTEND_MINI)
...
def grasshopper_config_file_path():
    ...
    assert os.path.exists("grasshopper_config.yaml")
    return "grasshopper_config.yaml"


# src/grasshopper_config.yaml
