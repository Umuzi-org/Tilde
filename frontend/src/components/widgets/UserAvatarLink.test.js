...
it("getAvatarTextInitials function returns correct initials from other emails", () => {
  ...
  expect(getAvatarTextInitials("c.nyatondo@gmail.com")).toBe("CN");
  expect(getAvatarTextInitials("n0606160@gmail.com")).toBe("N0");
  expect(getAvatarTextInitials("08606160@gmail.com")).toBe("08");
});
