...
import GithubAcivity from "../components/regions/UserStats/GithubAcivity"
// import activityLog from "./assets/githubUserActivity.json"

const dates = [
    "Mon 1 ","Tues 1", "Wed 1","Thurs 1", "Fri 1", "Sat 1", "Sun 1", 
    "Mon 2","Tues 2", "Wed 2","Thurs 2", "Fri 2", "Sat 2", "Sun 2",
    // "Mon 3","Tues 3", "Wed 3","Thurs 3", "Fri 3", "Sat 3", "Sun 3"
]


const eventTypes = [
    "Push", "PullRequestReview", "TildeCardReview", "TildeCardComplete"
]
